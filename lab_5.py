...
def index():
    if current_user.is_authenticated:
        return render_template('index.html', lab_title="Лабораторная работа с Flask-Login", lab_description="Данная лабораторная работа показывает использование Flask-Login.", user=current_user)
    return redirect(url_for('login'))
